...
I'm getting errors here and I'm not sure where they're coming from or how to fix them. Google says that I'm trying to add something too big to a matrix of a set size, but I'm not entirely sure where to start.